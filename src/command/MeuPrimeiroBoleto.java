 ...
 * @version 0.2
 */
public class MeuPrimeiroBoleto implements Command {
	...
	public void executar(HttpServletRequest request, HttpServletResponse response)
		 ...
		 */
		Cedente cedente = new Cedente("Empresa Teseus", "00.000.208/0001-00");

		/*
		 * INFORMANDO DADOS SOBRE O SACADO.
		 */
		// Sacado sacado = new Sacado("Cliente", Cliente.getCpf() );
		Sacado sacado = new Sacado(cliente.getNome(), "111.111.111-11");
		...
		enderecoSac.setCep(new CEP(ClienteEndereco.getCep_endereco()));
		...
		boleto.setInstrucaoAoSacado(
				"Senhor cliente, sabemos sim que o valor " + "cobrado não é o esperado, aproveite o DESCONTÃO!");
		...
		response.sendRedirect("FormasPagamento.jsp");		
	...
	/*private static void mostreBoletoNaTela(File arquivoBoleto) {
		...
		System.out.println("mostrando boleto...");
	}*/
