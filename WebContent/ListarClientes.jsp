...
<title>Listar e Editar Clientes</title>
	...
	<div id="main" class="container">
		<form action="controller.do" method="get">
			<div id="top" class="row">
				<div class="col-md-3">
					<h2>Listar e Editar Clientes</h2>
				</div>
				...
				<div class="col-md-3">
					<a href="CadastroCliente.jsp" class="btn btn-primary pull-right h2">Cadastrar Novo Cliente</a>
				</div>
			</div>
			<!-- /#top -->
		</form>
			...
			<div id="listaC" class="row">
				<div class="table-responsive col-md-12">
					<table class="table table-striped">
						...
						<tbody>
							<c:forEach var="cliente" items="${listaC}">
								<tr>
									<th>${cliente.id}</th>
									<th>${cliente.nome}</th>
									<th>${cliente.cpf}</th>
